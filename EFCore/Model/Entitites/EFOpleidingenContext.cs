...
namespace Model.Entitites
{
    public class EFOpleidingenContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured) //Enkel uitvoeren als er nog geen database geconfigureerd werd (voor unittesten : inmemory/sqllite)
            {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            if (!testMode)
            {
                ...
                new Boek { BoekNr = 1, IsbnNr = "0-0705918-0-6", Titel = "C++ : For Scientists and Engineers" },
                new Boek { BoekNr = 2, IsbnNr = "0-0788212-3-1", Titel = "C++ : The Complete Reference" },
                new Boek { BoekNr = 3, IsbnNr = "1-5659211-6-X", Titel = "C++ : The Core Language" },
                new Boek { BoekNr = 4, IsbnNr = "0-4448771-8-5", Titel = "Relational Database Systems" },
                new Boek { BoekNr = 5, IsbnNr = "1-5595851-1-0", Titel = "Access from the Ground Up" },
                new Boek { BoekNr = 6, IsbnNr = "0-0788212-2-3", Titel = "Oracle : A Beginner''s Guide" },
                new Boek { BoekNr = 7, IsbnNr = "0-0788209-7-9", Titel = "Oracle : The Complete Reference" });
                #endregion
